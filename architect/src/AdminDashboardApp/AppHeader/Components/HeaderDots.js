...
import "./HeaderDots.css"; // External stylsheet

// import Ionicon from 'react-ionicons';
import {
  // IoIosGrid, // Hash dropdown
  // IoIosNotificationsOutline, // Notification Dropdown
  // IoIosAnalytics, // Users Online Dashboard
} from "react-icons/io";
...
import {
  ...
  DropdownToggle,
  // DropdownMenu,
  // Nav, // Users Online Dashboard
  // Col, // Hash dropdown
  // Row, // Hash dropdown
  // Button, // Users Online Dashboard
  // NavItem, // Users Online Dashboard
  // DropdownItem,
} from "reactstrap";

// Users Online Dashboard
...
// import city3 from "../../../assets/utils/images/dropdown-header/city3.jpg"; // Notification Dropdown

import Flag from "react-flagkit";

// import Tabs from "react-responsive-tabs"; // Notification Dropdown
          ...
          <UncontrolledDropdown>
            ...
            <UncontrolledDropdown>
              <DropdownToggle className="p-0 mr-2" color="link">
                <div className="icon-wrapper icon-wrapper-alt rounded-circle">
                  <div className="icon-wrapper-bg bg-focus" />
                  <div className="language-icon" id="country-germany">
                    <Flag className="mr-3 opacity-8" country="MX" size="40" />
                  </div>
                </div>
              </DropdownToggle>              
              {/* <DropdownMenu right className="rm-pointers">
