...
// import { IoIosCalendar } from "react-icons/io"; // Calendar option
...
import {
  ...
  // NavItem,
  // NavLink,
  // UncontrolledTooltip, // Calendar option
  UncontrolledButtonDropdown,
} from "reactstrap";

import { toast, Bounce } from "react-toastify";

// import { faAngleDown, /*faSleigh*/ } from "@fortawesome/free-solid-svg-icons";

import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";

// import city3 from "../../../assets/utils/images/dropdown-header/city3.jpg";
import avatar1 from "../../../assets/utils/images/download.png";
...
class UserBox extends React.Component {
  ...
  fetchAdmin(){
    fetch("/backend/admin/fetch/admin/appHeader",
          {
            method: "POST", 
            'credentials': 'include'            
          }
    ).then((res)=>res.json()).then((data)=>{
        this.setState({fullName:data.fullName,profTitle:data.profTitle})
    });
  }


  logOut(){            
    fetch("/backend/architect_dashboard/logout",
          {
            method: "POST", 
            'credentials': 'include',
            body: JSON.stringify({logOutBy:"admin"}),
            headers: {
          ...
          <div className="widget-content p-0">
            <div className="widget-content-wrapper">
              ...
              <div className="widget-content-left  ml-3 header-user-info">
                <div className="widget-heading">{this.state.fullName}</div>
                <div className="widget-subheading">{this.state.profTitle}</div>
              </div>
                <button className="btn btn-primary ml-3" onClick={this.logOut}>Log Out</button>                                                              
              {/* 
