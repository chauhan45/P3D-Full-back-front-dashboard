      ...
      <div className="app-page-title">
        <div className="page-title-wrapper">
          <div className="page-title-heading">
            ...
            <div>
              ...
              <div className={cx("page-title-subheading", {
                ...
                <Link to="/admin/dashboard"><FontAwesomeIcon icon={faHome} /> / Dashboards</Link>
              </div>
            </div>
          </div>
          <div className="page-title-actions">
            ...
            <a href="#/dashboard/new-customer"><button class="btn btn-primary">New Customer</button></a>
            {/* <LaddaButton className="btn btn-shadow btn-pill btn-wide btn-focus mr-4" loading={this.state.expZoomIn}
              onClick={() => this.toggle("expZoomIn")} data-style={ZOOM_IN}>
              New Partner
            </LaddaButton> */}
            <a href="#/dashboard/new-partner"><button class="btn btn-primary ml-4">New Partner</button></a>
            {/* <LaddaButton className="btn btn-shadow btn-pill btn-wide btn-focus" loading={this.state.expZoomIn}
              onClick={() => this.toggle("expZoomIn")} data-style={ZOOM_IN}>
              New Project
            </LaddaButton> */}
            <a href="#/dashboard/new-project/info"><button class="btn btn-primary ml-4">New Project</button></a>
          </div>
        </div>
      </div>
    );
