...
export default function CustomerDashboardViewProfileDetailsPage(){
    ...
    function notificationsPreference(){        
        fetch("/backend/customerDashboard/notificationPreference",
          {
            method: "POST", 
            'credentials': 'include',
            headers:{
    ...
    return (
        <div>
            ...
            <div className="profile_grid">
                ...
                <a className="profile_grid_item profile_grid_item_details" href="#/dashboard/view-profile/details">Details</a>
