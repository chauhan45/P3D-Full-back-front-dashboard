    ...
    return (
        <div>
            ...
            <div className="profile_grid">
                ...
                <a className="profile_grid_item profile_grid_item_billing" href="#/dashboard/partner/view-profile/billing">Billing</a>                                                               
            </div> 
            <div className="container ml-n3">
                <div className="col">
                    <div className="row">
                        <div className="col-2">
                            <img className="profile_image" alt="profile_image" width={120} height={120}  src={imageSrc0}></img>
                        </div>                               
