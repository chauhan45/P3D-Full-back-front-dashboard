...
export default function CustomerDashboardViewProfileSecurityPage(){    
    ...
    return (
        <div>
            ...
            <div className="profile_grid">
                ...
                <a className="profile_grid_item profile_grid_item_security" href="#/dashboard/partner/view-profile/security">Security</a>
                ...
                <div className="block0_1">
                    ...
                    <div className="block0_1_1">
                        <p className="block0_1_1_0">
                            ...
                            <input type="password" id="block0_1_1_0_1" placeholder="Password" required/>                            
                            <input type="password" id="block0_1_1_0_2" placeholder="Confirm Password" required/>                            
                        </p>
                    </div>
