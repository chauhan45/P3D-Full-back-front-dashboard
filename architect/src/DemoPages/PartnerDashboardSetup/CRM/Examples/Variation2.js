      ...
      <Fragment>
        <CSSTransitionGroup component="div" transitionName="TabsAnimation"
          ...
          <div>
                  ...
                  <div className="widget-content-outer">
                    <div className="widget-content-wrapper">
                      <div className="widget-content-left">
                        <div className="widget-heading top-blocks-headings">Submitted</div>
                    ...
                    <div className="widget-progress-wrapper">
                      ...
                      <div className="progress-sub-label">
                        ...
                        <div className="widget-numbers text-success top-blocks-subheadings"> 1896</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Col md="6" xl="2">
                <div className="card mb-3 widget-content">
                  <div className="widget-content-outer">
                    <div className="widget-content-wrapper">
                      <div className="widget-content-left">
                        <div className="widget-heading top-blocks-headings">Processed</div>
                    ...
                    <div className="widget-progress-wrapper">
                      ...
                      <div className="progress-sub-label">
                        ...
                        <div className="sub-label-right">100%</div> */}
                        <FontAwesomeIcon icon={faHome} />
                        <div className="widget-numbers text-warning top-blocks-subheadings"> $3M</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Col md="6" xl="2">
                <div className="card mb-3 widget-content">
                  <div className="widget-content-outer">
                    <div className="widget-content-wrapper">
                      <div className="widget-content-left">
                        <div className="widget-heading top-blocks-headings">Completed</div>
                        {/* <div className="widget-subheading">
                          People Interested
                        </div> */}
                      </div>
                    ...
                    <div className="widget-progress-wrapper">
                      ...
                      <div className="progress-sub-label">
                        ...
                        <div className="sub-label-right">100%</div> */}
                        <FontAwesomeIcon icon={faHome} />
                        <div className="widget-numbers text-danger top-blocks-subheadings"> 45</div>
                      </div>
                    </div>
                  </div>
                </div>
              </Col>
              <Col md="6" xl="2" // className="d-xl-none d-lg-block"
              >
                <div className="card mb-3 widget-content">
                  <div className="widget-content-outer">
                    <div className="widget-content-wrapper">
                      <div className="widget-content-left">
                        <div className="widget-heading top-blocks-headings">Schedules</div>
                    ...
                    <div className="widget-progress-wrapper">
                      ...
                      <div className="progress-sub-label">
                        ...
                        <div className="sub-label-right">100%</div> */}
                        <FontAwesomeIcon icon={faHome} />
                        <div className="widget-numbers text-focus top-blocks-subheadings"> $147</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Col md="6" xl="2">
                <div className="card mb-3 widget-content">
                  <div className="widget-content-outer">
                    <div className="widget-content-wrapper">
                      <div className="widget-content-left">
                        <div className="widget-heading top-blocks-headings">Estimates</div>
                        {/* <div className="widget-subheading">
                          People Interested
                        </div> */}
                      </div>
            ...
            <SearchField placeholder="Search for order id, customer, project name, city, or state" classNames="search-partner mb-4"/>
            <Card className="main-card mb-3">
              <CardHeader className="card-header-tab">
                <div className="card-header-title font-size-lg text-capitalize font-weight-normal">
                  {/* <i className="header-icon lnr-dice mr-3 text-muted opacity-6"> {" "} </i> // Dice icon*/}
                  All Projects
                </div>
                  ...
                  columns={[
                    {
                      columns: [
                        ...
                        },
                        {
                          ...
                          accessor: "Download",  
                          className:"table_data",                                                 
                          Cell: row => <select class="download_button">                                          
                        ...
                        },
                        {
                          ...
                          className:"table_data",                                                    
                          Cell: row => <span class="file_status">Needs Edit</span>
                        },

                        // First Name and Last Name Table Rows
                        // {
                        //   Header: "First Name",
                        //   accessor: "firstName",
                        // },
                    ...
                    },
                    {
                      columns: [
                        ...
                        },
                        {
                          ...
                          accessor: "Action",
                          className:"table_data",                          
                          Cell: row => (<div><span class="edit_button">Edit</span><span class="delete_button">Delete</span></div>)
                        }
                        // Status Row
                        // {
                        //   Header: "Status",
                      ...
                      <div className="widget-chart p-0">
                        <ResponsiveContainer height={223}>
                          <AreaChart data={data22} margin={{ top: -25, right: 0, left: 0, bottom: 0 }}>
                            ...
                            <Tooltip />
                            <Area type="monotoneX" dataKey="uv" stroke="var(--warning)" strokeWidth={2}
                            ...
                            <ResponsiveContainer height={114}>
                              <AreaChart data={data3}
                                ...
                                <Area type="monotoneX" dataKey="uv" stroke="var(--primary)"
                                  strokeOpacity=".8" strokeWidth={3} fill="var(--primary)" fillOpacity=".08"/>
                              </AreaChart>
                            </ResponsiveContainer>
                          </div>
                        </div>
                          ...
                          <div className="widget-chart-wrapper widget-chart-wrapper-lg he-auto opacity-3 m-0 p-1">
                            <ResponsiveContainer height={114}>
                              <AreaChart data={data2}
                                ...
                                <Tooltip />
                                <Area type="monotoneX" dataKey="uv" stroke="var(--danger)" strokeOpacity=".8"
                                  strokeWidth={3} fill="var(--danger)" fillOpacity=".08"/>
                              </AreaChart>
                            </ResponsiveContainer>
                          </div>
                        </div>
                            ...
                            <div className="widget-chart-wrapper he-auto opacity-10 m-0">
                              <ResponsiveContainer height={162}>
                                <AreaChart data={data55}
                                  ...
                                  <Tooltip />
                                  <Area type="monotoneX" dataKey="uv" strokeWidth={0} fill="var(--info)"/>
                                </AreaChart>
                              </ResponsiveContainer>
                            </div>
                          </div>
