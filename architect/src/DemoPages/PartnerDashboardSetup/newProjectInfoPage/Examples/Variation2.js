...
export default function PartnerDashboardNewProjectInfoPage(){
    return (
        <>
            <h1>New Project</h1>
            <br/>
            <div className="profile_grid">
                <a className="profile_grid_item profile_grid_item_info" href="#/dashboard/partner/new-project/info">Info</a>
                <a className="profile_grid_item profile_grid_item_details0" href="#/dashboard/partner/new-project/details">Details</a>                
            </div> 
            <div>
