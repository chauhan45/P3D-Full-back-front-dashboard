...
export default class PartnerDashboardNewCustomerPage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            error: '',
    ...
    fetchCompanyName(){
        fetch("/partnerDashboard/fetch/own/companyName",{
            method:"POST",
            'credentials':'include'
        }).then(data0=>data0.text()).then((data1=>{
            console.log(data1);
            this.setState({companyName:data1});
        }));
    }
                            ...
                            <div class="col-12 col-md-5 col-lg-10 py-8 py-md-11">
                                ...
                                <form class="mb-6" onSubmit={this.onSubmit}>
                                    ...
                                    <div class="form-group mb-5">
                                        ...
                                        <select id="partnerCompanyNameSelect" className="form-control" onChange={this.onChangeCompanyName} value={this.state.companyName} disabled>                                             
                                            <option value="P3D">{this.state.companyName}</option>
                                        </select>                                                                                                                        
                                    </div>
                                    <h6>Address</h6>
                                    <br/>
