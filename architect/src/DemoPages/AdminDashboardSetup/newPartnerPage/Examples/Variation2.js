...
export default class AdminDashboardNewPartnerPage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            error: '',
    ...
    handleFormValidation() {
        const { firstName, lastName, email, mobileNumber, password, companyName, confirmPassword, streetAddress, city, state, zipCode, companyType, industryType } = this.state;
        let formErrors = {};
    ...
    onSubmit(e) {
        ...
        if (this.handleFormValidation()) {
            ...
            axios.post("/admin/add/partner", data)
    ...
    render() {
        const { firstNameErr, lastNameErr, emailErr, mobileNumberErr, passwordErr, confirmPasswordErr, companyNameErr, streetAddressErr, cityErr, stateErr, zipCodeErr, companyTypeErr, industryTypeErr } = this.state.formErrors;
        return (
            <>
                                    ...
                                    <div class="row form-group">
                                        <div class="form-group mb-5 col-md-6">
                                            ...
                                            <select type="text" value={this.state.companyType} onChange={this.onChangeCompanyType} id="company-type" name="company-type"
                                                ...
                                                <option value="Other" onClick={this.companyTypeOther}>Other</option>
                                            </select>
