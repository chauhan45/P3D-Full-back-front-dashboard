    ...
    content: [
      {
        icon: "pe-7s-user",
        label: "All Customers",
        to: "#/dashboard/partner/all-customers",
      },
      {
        icon: "pe-7s-user",
        label: "New Customer",
        to: "#/dashboard/partner/new-customer",
      },
...
export const SettingsNav = [
  {
    icon: "pe-7s-id",
    label: "View Profile",
    to: "#/dashboard/partner/view-profile/contact",
  },
  {
    icon: "pe-7s-config",
    label: "My Account",
    to: "#/dashboard/partner/my-account ",
  },
  {
    icon: "pe-7s-graph",
    label: "Billings",
    to: "#/dashboard/partner/billings",
  },
  {
    icon: "pe-7s-settings",
    label: "Admin",
    to: "#/dashboard/partner/admin ",
